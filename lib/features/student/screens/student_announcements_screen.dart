...
class _StudentAnnouncementsScreenState extends State<StudentAnnouncementsScreen> {
  static const categories = ['All', 'Academic', 'Placement', 'Hackathon', 'Cultural', 'Sports', 'Scholarship', 'Conference'];
