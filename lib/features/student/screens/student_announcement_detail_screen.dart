                  ...
                  _card(
                    ...
                    [
                      ...
                      if (announcement.attachmentUrl != null &&
                          _isPdf(announcement.attachmentUrl!))
                        Padding(
                          ...
                          child: FilledButton.icon(
                            onPressed: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (_) => StudentPdfViewerScreen(
                            ...
                            label: const Text('View PDF attachment'),
                          ),
                        ),
                      if (announcement.attachmentUrl != null &&
                          !_isPdf(announcement.attachmentUrl!))
                        const Padding(
                          ...
                          child: Text(
                            'An attachment is available, but its file type is not confirmed as PDF.',
                            style: TextStyle(
