      ...
      body: ListView(
        ...
        children: [
          ...
          _item(
            ...
            () => _open(context, const StudentMorningBriefScreen()),
          ),
          _item(
            context,
            '11:00 AM',
            ...
            '45 min',
            Icons.mic_outlined,
            () => _open(context, const StudentVoiceHomeScreen()),
          ),
          _item(
            context,
            '4:00 PM',
            'Career & Placement Hour',
            '60 min',
            Icons.business_center_outlined,
            () => _open(context, const StudentCareerPlacementScreen()),
          ),
          _item(
            context,
            '6:00 PM',
            'Day-End Campus Bulletin',
            '30 min',
